...
class Application:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.window.partnum_select.view().setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
            self.image_selected = False
            self.window.setEnabled(False)
            self.window.label_21.setPixmap(QPixmap("resources/mviis.png"))
            self.window.label_17.setPixmap(QPixmap("resources/mviis.png"))
            self.window.label_15.setPixmap(QPixmap("resources/cust.png"))
            self.window.label_18.setPixmap(QPixmap("resources/cust.png"))
