...
if __name__=="__main__":
    # try:
    #     datestamp = requests.get("https://bdo.sanmina.com/timestamp.php",timeout=5).text
    #     subprocess.Popen(f"sudo date -s '{datestamp}'",shell=True)
    # except:
    #     pass 
    subprocess.Popen('sudo umount -a', shell=True)
    myapp= Application()